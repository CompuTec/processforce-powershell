...
Class CTLogger {
    ...
    [void] logToFile($subtask){
        ...
        $this.connectionType, $this.task,$subtask.name, $subtask.timer.startDateTime, $subtask.timer.endDateTime,  $subtask.timer.totalSeconds(), $subtask.status, $subtask.message);
    ...
    [void] prepareLogFile(){
        ...
        $content = [string]::Format("Connection Type; Task; Subtask; Start Time; End Time; Duration [s]; Task Status; Remarks");
        Add-Content -Path $this.fileName $content;
